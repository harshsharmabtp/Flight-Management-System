...
const paymenting6 = async (req, res) => {
    try {
            ...
            line_items: [
                {
                    price_data: {
                        ...
                        product_data: {
                            name: 'The Royal Palms Resort', // Update product name if needed
                        },
                        unit_amount: 208 * 100, // 289 INR converted to paise
                    },
                    quantity: 1,
                },
            ],
