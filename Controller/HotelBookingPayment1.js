...
const paymenting1 = async (req, res) => {
    try {
            ...
            line_items: [
                {
                    price_data: {
                        ...
                        product_data: {
                            name: 'The Grand Horizon Hotel', // Update product name if needed
                        },
                        unit_amount: 289 * 100, // 289 INR converted to paise
                    },
                    quantity: 1,
                },
            ],
