...
const paymenting10 = async (req, res) => {
    try {
            ...
            line_items: [
                {
                    price_data: {
                        ...
                        product_data: {
                            name: 'Serenity Bay Resort', // Update product name if needed
                        },
                        unit_amount: 115 * 100, // 289 INR converted to paise
                    },
                    quantity: 1,
                },
            ],
