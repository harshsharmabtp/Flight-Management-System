...
const paymenting5 = async (req, res) => {
    try {
            ...
            line_items: [
                {
                    price_data: {
                        ...
                        product_data: {
                            name: 'Crystal Waters Retreat', // Update product name if needed
                        },
                        unit_amount: 231 * 100, // 289 INR converted to paise
                    },
                    quantity: 1,
                },
            ],
