...
const paymenting7 = async (req, res) => {
    try {
            ...
            line_items: [
                {
                    price_data: {
                        ...
                        product_data: {
                            name: 'Luxe Haven Suites', // Update product name if needed
                        },
                        unit_amount: 346 * 100, // 289 INR converted to paise
                    },
                    quantity: 1,
                },
            ],
