...
const paymenting9 = async (req, res) => {
    try {
            ...
            line_items: [
                {
                    price_data: {
                        ...
                        product_data: {
                            name: 'Whispering Pines Lodge', // Update product name if needed
                        },
                        unit_amount: 139 * 100, // 289 INR converted to paise
                    },
                    quantity: 1,
                },
            ],
